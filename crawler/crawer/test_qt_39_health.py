...
start_url = "http://heart.39.net/093/17/816885.html"
ERROR = {
...
class Window( QtGui.QWidget ):
    def __init__( self ):
        ...
        self.setWindowTitle( "39健康网爬虫" )
        self.resize( 500, 500 )

        gridlayout = QtGui.QGridLayout()

        self.label = QtGui.QLabel("请输入网址：http://heart.39.net/*?")
        gridlayout.addWidget( self.label, 0,0)

        self.text_url = QtGui.QLineEdit("http://heart.39.net/gxy/")
