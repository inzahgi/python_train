...
pattern = re.compile(r'http://fashion.ifeng.com/health/new/*?')

pattern_url = re.compile(r'http://fashion.ifeng.com/health/*?')
...
class Window( QtGui.QWidget ):
    def __init__( self ):
        ...
        self.setWindowTitle( "凤凰健康网爬虫" )
        self.resize( 500, 500 )

        gridlayout = QtGui.QGridLayout()

        self.label = QtGui.QLabel("请输入网址：http://fashion.ifeng.com/health/*？")
        gridlayout.addWidget( self.label, 0,0)

        self.text_url = QtGui.QLineEdit("http://fashion.ifeng.com/health/news/qy/list_0/0.shtml")
