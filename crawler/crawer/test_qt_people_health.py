...
pattern = re.compile(r'http://health.people.com.cn/*?')

pattern_url = re.compile(r'http://health.people.com/cn/n/*?')

start_url = "http://health.people.com.cn/n/2014/0102/c14739-24003015.html"
ERROR = {
    ...
    def handle_starttag(self, tag, attrs):
        if tag == 'h1':
           for name1,value1 in attrs:
               if ((name1 == 'id')and(value1 == 'p_title')):
                   self.a_txt = True
                   self.a_title = True
        ...
        if tag == 'div': 
           for name1,value1 in attrs:
               if ((name1 == 'class')and(value1 == 'text')):
                    self.a_start = True
                    ##print("Encountered text start tag:", tag)
               if ((name1 == 'class') and (value1 == 'zdfy clearfix')):
                    self.a_start = False
                    ##print("Encountered text end tag(implant):", tag)
               if ((name1 == 'class') and (value1 == 'about')):
                    self.a_start = False
...
class Window( QtGui.QWidget ):
    def __init__( self ):
        ...
        self.setWindowTitle( "人民健康网爬虫" )
        self.resize( 500, 500 )

        gridlayout = QtGui.QGridLayout()

        self.label = QtGui.QLabel("请输入网址：http://health.people.com.cn/n/*?")
        gridlayout.addWidget( self.label, 0,0)

        self.text_url = QtGui.QLineEdit("http://health.people.com.cn/GB/14742/33410/index.html")
